...
<template>
<div :class="['carousel-center flex flex-col -mx-[20px] md:-mx-[100px] lg:-mx-[192px] my-[25px] py-[25px] md:my-[30px] md:py-[30px] xl:my-[2.5vw] xl:py-[2.5vw] 2xl:my-[50px] 2xl:py-[50px] gap-[40px] xl:gap-[60px]', {'bg-[--component-bg-alt]': bgColor}]">
