...
<template>
  <div class="carousel-badges flex flex-col gap-[30px] md:gap-[40px] xl:gap-[60px] text-center overflow-hidden w-auto -mx-[20px] md:-mx-[100px] lg:-mx-[192px] py-[50px] md:py-[60px] xl:py-[5vw] 2xl:py-[100px]">
